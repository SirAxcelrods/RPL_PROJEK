    ...
    <main id="login">
        <div class="container-fluid">
            <div class="row vh-100">
                <div id="halaman_kiri" style="background-color: #0B86A8;" class="col-md-5 d-flex justify-content-center align-items-center bg-opacity-50">
                    <img id="icon" src="assets/gercep.png" alt="">
                </div>
                <div id="halaman_kanan"  class="col-md-7 d-flex bg-white justify-content-center align-items-center flex-column">
